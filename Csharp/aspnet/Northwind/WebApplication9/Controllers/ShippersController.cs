...
namespace WebApplication9.Controllers
{
    public class ShippersController : Controller
    {
        ...
        public ShippersController(WebApplication9Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Shipper != null ? 
                          ...
                          Problem("Entity set 'WebApplication9Context.Shipper'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebApplication9Context.Shipper'  is null.");
            }
            var shipper = await _context.Shipper.FindAsync(id);
            if (shipper != null)
            {
