...
namespace WebApplication9.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(WebApplication9Context context)
        {
            _context = context;
        }
        ...
        {
            var webApplication9Context = _context.Product.Include(p => p.Category).Include(p => p.Supplier);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebApplication9Context.Product'  is null.");
            }
            var product = await _context.Product.FindAsync(id);
            if (product != null)
            {
